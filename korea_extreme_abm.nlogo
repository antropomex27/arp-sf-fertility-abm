;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; KOREA EXTREME ABM – VERSIÓN 1.0 (NetLogo)
...
persons-own [
  ...
  red_self      ;; índice interno adicional (0–5)
  age           ;; edad en años
  sex           ;; "M" o "F"
...
to update-stress
  ;; en este escenario el estrés tiende a subir más y se recupera menos
  let s-increase ([workload] of patch-here) * 0.03
  let stress-decay 0.02
...
to update-red-self
  ;; el estado interno baja si el estrés es alto crónico
  ;; y sube un poco cuando la energía es alta
...
to interact
  ;; decisión de intentar interactuar (baja si el estado interno está por debajo del umbral)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; REPORTERS ÚTILES (para monitores/plots)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to setup-results-file
  ...
  ;; Nombre del archivo para este escenario
  file-open "korea-extreme-run030.csv"
